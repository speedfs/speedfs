...
func generateProtoFile(fset *token.FileSet, f *ast.File, output string) {
	...
	// package
	b.WriteString("// Code generated by speedfs-rpcgen. DO NOT EDIT.\n\n")
	b.WriteString(fmt.Sprintf("package %s\n\n", f.Name))

	if path.Dir(input) != "rpc" {
...
func NewHandler(service %s) rpc.Handler {
	h := &handler{
...
const methodTpl = `
func (s *service) %s(ctx context.Context, buf []byte) (rpc.Message, error) {
	cmd := new(%sCommand)
